        ...
        <div className="container mx-auto px-6 pt-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              Experience the perfect blend of luxury, comfort, and care in
              beautiful Phuket. Whether you're planning retirement, investment,
              or a tailored vacation, we're here to guide you every step of the
              way.
            </p>

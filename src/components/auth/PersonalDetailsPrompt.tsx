...
export default function PersonalDetailsPrompt({ isOpen, onClose, onSave }: PersonalDetailsPromptProps) {
      ...
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-8">
            Please provide your personal details to help us better assist you with your interests.
          </p>

...
export const carePackages: CarePackage[] = [
  {
    ...
    description: "Essential assistance for independent seniors who need occasional help.",
    icon: Heart,
  ...
  },
  {
    ...
    description: "Comprehensive medical support with regular monitoring and assistance.",
    icon: Stethoscope,
  ...
  },
  {
    ...
    description: "Round-the-clock professional care and support for all daily activities.",
    icon: Clock,
  ...
  },
  {
    ...
    description: "Tailored care programs for specific conditions and requirements.",
    icon: UserCog,
